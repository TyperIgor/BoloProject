...
using Bolo.Integration.Core.Dates;
using Bolo.Integration.Core.Processors.FileRead;

namespace Bolo.Integration.Core.Excel
{
    public class OperateExcel
    {
        public void ExecuteOnExcel(Path path)
        {
            Spreadsheet spreadsheet = new Spreadsheet();
            Worksheet sheets = spreadsheet.Workbook.Worksheets.Add("Bolo");
